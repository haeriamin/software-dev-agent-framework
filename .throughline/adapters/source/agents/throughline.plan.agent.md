...
4. Create `specs/NNN-*/plan.md` from `.throughline/templates/plan-template.md`:
...
8. Report: plan path, complexity class, confidence, design requirement status, readiness for `/throughline.tasks`. Append to `wiki/log.md`.
