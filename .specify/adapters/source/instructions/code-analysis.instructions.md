...
The report format in `.specify/extensions/dev/commands/dev.analyze.md` §Steps is mandatory — all sections, even when a section's honest content is "none found".
