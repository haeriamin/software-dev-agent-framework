...
Runbook: `.specify/extensions/dev/commands/dev.review-escalated.md` — follow step-by-step. Artifact format: [escalation protocol](../instructions/escalation-protocol.instructions.md).
