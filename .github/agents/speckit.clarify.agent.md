...
1. Locate the active feature via `.specify/feature.json` (fallback: highest `specs/NNN-*`). Load `spec.md`.
...
7. Report: markers resolved, markers remaining, readiness for `/speckit.plan`. Append to `wiki/log.md`.
