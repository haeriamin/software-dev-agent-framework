...
Follow [implementation rules](../instructions/implementation-rules.instructions.md) — cardinal rules, change application order, DEV-STATUS annotation convention. Runbook: `.specify/extensions/dev/commands/dev.implement.md` (and `dev.scaffold.md` for greenfield).
