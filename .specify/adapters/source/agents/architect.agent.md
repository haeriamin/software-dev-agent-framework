...
handoffs:
  - label: Break design into tasks
    agent: Orchestrator
    prompt: Design approved. Continue the lifecycle at /speckit.tasks.
    send: true
...
Runbook: `.specify/extensions/dev/commands/dev.design.md`. Template: `.specify/templates/design-template.md`.
