...
- `/dev.ingest-standards` → `.specify/extensions/dev/commands/dev.ingest-standards.md`
- `/dev.ingest-exemplars` → `.specify/extensions/dev/commands/dev.ingest-exemplars.md`
- `/dev.lint-wiki` → `.specify/extensions/dev/commands/dev.lint-wiki.md`
