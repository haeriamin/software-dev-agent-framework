...
Runbook: `.specify/extensions/dev/commands/dev.feature.md` — follow step-by-step, including resume and mode detection before starting and the Final Report format at the end.
