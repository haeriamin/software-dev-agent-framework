...
Follow [review protocol](../instructions/review-protocol.instructions.md) — independence rule, three layers, scoring with numerators/denominators, findings format. Runbook: `.specify/extensions/dev/commands/dev.review.md`.
