...
handoffs:
  ...
  - label: Plan from this analysis
    agent: Orchestrator
    prompt: Analysis complete. Continue the lifecycle at /speckit.plan.
    send: true
---
...
Follow [code analysis instructions](../instructions/code-analysis.instructions.md) step-by-step. Runbook: `.specify/extensions/dev/commands/dev.analyze.md`.
