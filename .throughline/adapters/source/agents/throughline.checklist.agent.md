...
2. Create `specs/NNN-*/checklists/<type>.md` from `.throughline/templates/checklist-template.md`.
...
5. Report failures with the lifecycle phase that owns the fix. Append to `wiki/log.md`.
